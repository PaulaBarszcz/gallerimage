...
class Fetcher extends React.Component {
  ...
  componentDidMount() {
    fetch("https://api.flickr.com/services/rest/?method=flickr.photos.search&api_key=677f0332a9e20fbbdd0abefde03c3461&tags=dog&text=dog&format=json&nojsoncallback=1&auth_token=72157696959738981-a2d54d53fc4dbde6&api_sig=fcefa8fad5d62840d3cbd9c7197f22b2")
      .then(res => res.json())
      .then(
        (result) => {
          this.setState({
